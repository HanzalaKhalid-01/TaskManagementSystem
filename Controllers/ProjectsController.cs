...
namespace TaskManagementSystem.Controllers
{
    public class ProjectsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "project_id,user_id,project_name,description,start_date,end_date,created_by,created_at,updated_at")] Project project)
        {
            if (ModelState.IsValid)
            {
